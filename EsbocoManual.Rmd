...
```{r, eval=FALSE}
dataframe <- read.csv("Caminho-do-seu-arquivo.csv", header=TRUE) #Separador ,
dataframe2 <- read.csv2("Caminho-do-seu-arquivo.csv", header=TRUE) #Separador ;
...
Para a parte de manipulação de dados iremos utlizar o pacote **dplyr**, que é muito utilizado hoje em dia e também muito útil.  
